<template>
  <div class="relative mx-2 sm:mx-24 py-12 h-96 pb-96">
    ...
    <div class="hidden sm:block">
      <button @click="prev"
        class="absolute top-1/2 left-20 max-[1300px]:-left-20 m-4 opacity-50 hover:opacity-100 ease-in duration-100">
      ...
      <button @click="next"
        class="absolute top-1/2 right-20 max-[1300px]:-right-20 m-4 opacity-50 hover:opacity-100 ease-in duration-100">
        <svg width="55" height="55" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="35" cy="35" r="35" fill="black" />
