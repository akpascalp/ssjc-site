    ...
    <div class="grid grid-cols-2 pt-2">
      ...
      <div class="">
        <div class="text-[16px] pr-16 pb-16">
          <p>
          <p class="font-bold">What is Brazilian Jiu-Jitsu?</p>
          Brazilian Jiu-Jitsu (BJJ) is a ground-based martial art that originated from Judo and focuses on submission
          holds.
          <br />
          Developed in the 1920s by the Gracie family, BJJ builds upon the principles of Judo while placing a particular
          emphasis on ground fighting and grappling techniques.
          <br />
          The central theme of Brazilian Jiu-Jitsu is the ability to control and submit an opponent through superior
          technique and leverage, regardless of their size or strength. By utilizing precise positioning, joint locks, and
          chokes, practitioners aim to neutralize and overcome their adversaries.
          <br />
          <br />
          <p class="font-bold">Why Practice Brazilian Jiu-Jitsu?</p>
          Similar to Judo, Brazilian Jiu-Jitsu provides practitioners with a profound understanding of the human body's
          mechanics and limitations. It develops attributes such as body awareness, flexibility, timing, and
          problem-solving skills. BJJ also fosters mental discipline, self-confidence, and the ability to remain calm and
          composed under pressure.
          <br />
          <br />
          <p class="font-bold">For Whom?</p>
          Brazilian Jiu-Jitsu is suitable for beginners in martial arts, starting from the age of 12. Whether you are new
          to combat sports or have a background in Judo or BJJ, training in Brazilian Jiu-Jitsu offers an opportunity to
          enhance your grappling skills, refine your techniques, and continue your martial arts journey.
          </p>
        </div>
