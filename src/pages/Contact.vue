  ...
  <div class="px-12">
    ...
    <div class="grid grid-cols-2 place-content-between">
      <div>
        ...
        <p class="text-[16px] text-[#7C7C7C] underline">17 Đường Số 16, Thảo Điền, Quận 2,<br />
          ...
          Viêt Nam
          <a href="https://maps.google.com/" class="text-blue-500">(View on map)</a></p>
      </div>
      <div class="ml-28">
    ...
    <form>
      <div v-for="field in fields" class="grid grid-cols-1 gap-3 pb-8">
        ...
        <label class="text-[16px] text-[#7C7C7C]">{{ field.placeholder }}</label>
        <input type="text" class="w-full border-0 border-b-2 border-gray-200 p-0 focus:ring-gray-100 active:ring-gray-100">
      </div>
      ...
      <div class="my-8 grid grid-cols-2">
        ...
        <button class="btn-secondary justify-self-end w-56">
          Send
        </button>
      </div>
...
export default {
  ...
  data() {
    return {
      fields: [
        { title: 'Your Name', placeholder: 'e.g, Benjamin' },
        { title: 'Your Surname', placeholder: 'e.g, Nguyen' },
        { title: 'Your Date of Birth', placeholder: 'dd/mm/yyyy' },
        { title: 'Your Email', placeholder: 'mail@ssjc.com' },
        { title: 'Your Phone Number', placeholder: '+84 02xx xxx xxxx' },
      ]
    }
  },
  methods: {
